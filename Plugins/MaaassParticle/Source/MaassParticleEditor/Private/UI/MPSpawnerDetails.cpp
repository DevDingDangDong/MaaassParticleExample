...
void FMPSpawnerDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
    ...
    if (Spawner.IsValid() && Spawner->MPSpawnerDataAsset)
    {
        ...
        MPSpawnerDataAssetCategory.AddProperty(GET_MEMBER_NAME_CHECKED(AMPSpawner, ParticleScale));
        MPSpawnerDataAssetCategory.AddProperty(GET_MEMBER_NAME_CHECKED(AMPSpawner, ParticleScaleRatio));
    ...
    else
    {
        ...
        DetailBuilder.HideProperty(GET_MEMBER_NAME_CHECKED(AMPSpawner, ParticleScale));
        DetailBuilder.HideProperty(GET_MEMBER_NAME_CHECKED(AMPSpawner, ParticleScaleRatio));
